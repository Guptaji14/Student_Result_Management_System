...
try
{
	...
	ResultSet rs=st.executeQuery("select * from student inner join result where student.rollNo=result.roll_No and student.rollNo='"+rollNo+"'");
	if(rs.next()){
%>
...
Designed & Developed by Ashish Gupta</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @Ashish Gupta</h6></center> 
  <hr class="new1">
</body>
